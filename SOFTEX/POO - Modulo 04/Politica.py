...
while (True):
    try:
        ...
        print("\t", cadastro.candidatos.Carlos.name,
              "-", cadastro.candidatos.Carlos.value)
        print("\t", cadastro.candidatos.Maria.name,
              "-", cadastro.candidatos.Maria.value)
        print("\t", cadastro.candidatos.Pedro.name,
              "-", cadastro.candidatos.Pedro.value)
        print("\t", cadastro.candidatos.Branco.name,
              "-", cadastro.candidatos.Branco.value)
        voto = int(
            input("Informe seu voto, digitando o número referente ao seu candidato: "))
